...
{ handle: "@malluflix_official", name: "Athul Thampan", followers: 219947, niche: "Lifestyle", costPerDeliv: 0, numDelivs: 0, note: "Reel creator · mallumoviereviews@gmail.com · Follows @dokimeats" },
  { handle: "@nandu_ofl", name: "Nandu", followers: 111151, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · businesswithnandu@gmail.com · Follows @dokimeats" },
  ...
  { handle: "@vijaysubramaniam84", name: "Vijay Subramaniam", followers: 72219, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@itsbhupesh", name: "Bhupesh Bansal", followers: 66015, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "bhupesh210@gmail.com · Follows @dokimeats" },
  ...
  { handle: "@simi_chadha_", name: "Simi Chadha", followers: 68614, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · Follows @dokimeats" },
  ...
  { handle: "@raihanrvadra", name: "Raihan", followers: 44074, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Artist · raihanrrv@gmail.com · Follows @dokimeats" },
  { handle: "@farmizenofficial", name: "Farmizen - Farm, Together", followers: 131962, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Community · support@farmizen.com · Follows @dokimeats" },
  ...
  { handle: "@zinbyaastha", name: "Aastha Madaan | Psychologist", followers: 10417, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Psychologist · contactaastha94@gmail.com · Follows @dokimeats" },
  ...
  { handle: "@urjita_wani", name: "Urjita Wani", followers: 76469, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Comedian · Follows @dokimeats" },
  ...
  { handle: "@ronica_singh", name: "Ronnica 💙", followers: 46732, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Actor · Follows @dokimeats" },
  { handle: "@ashaiscool", name: "Asha Thacker", followers: 33184, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@shambhavi_shiva", name: "Shambhavi Shiva 🇮🇳", followers: 46307, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  ...
  { handle: "@chairs_and_company", name: "Chairs & Company - Bespoke Furniture Studio", followers: 14381, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Furniture · chairsandcompany1069@gmail.com · Follows @dokimeats" },
  ...
  { handle: "@rachelsfrancis", name: "Rachel Francis", followers: 10309, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "rachelfrancisbookings@gmail.com · Follows @dokimeats" },
  ...
  { handle: "@culinarycartel", name: "Akshita Paul 🍽", followers: 23740, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · theculinarycartel@gmail.com · Follows @dokimeats" },
  { handle: "@jomon.thomas8384", name: "Jomon Thomas", followers: 15863, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@busy_avacadobee", name: "Franisha Francis Lifestyle", followers: 15120, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "review · Blogger · franifrancis433@gmail.com · Follows @dokimeats" },
  { handle: "@beyondgeography", name: "ʙᴇʏᴏɴᴅ ɢᴇᴏɢʀᴀᴘʜʏ ✈︎", followers: 21912, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@dubaeee", name: "Aryan", followers: 11566, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@shia.og", name: "Shia OG", followers: 30496, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  ...
  { handle: "@missnavyarao", name: "Navya Pulagala", followers: 17830, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  ...
  { handle: "@_thisgirlisnoone_", name: "Shikha", followers: 22057, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  ...
  { handle: "@aayushvyas09", name: "Aayush Vyas", followers: 10830, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@souvikdutta_11", name: "Souvik Dutta", followers: 15152, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  ...
  { handle: "@cheeseareus", name: "CHEESESAREUS", followers: 4537, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Entrepreneur · cheesesareus42@gmail.com · Follows @dokimeats" },
  { handle: "@parapopofficial", name: "PARAPOP by PARALOVE", followers: 8124, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Community · parapop@paralove.in · Follows @dokimeats" },
  ...
  { handle: "@speed_mutant", name: "Shekhar Singh", followers: 11633, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@yashraj99", name: "Yashraj Pandit", followers: 12013, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@speedworksofficial", name: "SPEEDWORKS® - Tuning, Dyno, Racing", followers: 4848, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Motorsports Store · hq@speedworks.cc · Follows @dokimeats" },
  ...
  { handle: "@aishaupmanyu", name: "Aisha Upmanyu", followers: 8184, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "manyumanyu@gmail.com · Follows @dokimeats" },
  ...
  { handle: "@chitra_nalwade93", name: "Chitra Nalwade", followers: 35885, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Blogger · Follows @dokimeats" },
  { handle: "@v1n33", name: "Vineeth Sivakumar", followers: 11782, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@magdumshubham", name: "Shubham Magdum", followers: 13912, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  ...
  { handle: "@mridulaganesan", name: "Mridula Ganesan", followers: 5350, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Entrepreneur · ganesanmridula@gmail.com · Follows @dokimeats" },
  ...
  { handle: "@ummesalma3_", name: "Ummesalma shakir", followers: 3529, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@apurvagovind", name: "Apurva A Govind", followers: 7352, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@msmunniforlittles", name: "Munira", followers: 5158, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@jaikumarchristhurajan", name: "Jaikumar Christurajan", followers: 6298, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@cat.on.cocaine", name: "Promita", followers: 6260, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  ...
  { handle: "@rayyanmonkey", name: "Rayyan (Rayyana)", followers: 7502, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "search@fatsmeagol.org · Follows @dokimeats" },
  { handle: "@alangkirat", name: "Kirat Alang", followers: 3227, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Film Director · kiratalang2@gmail.com · Follows @dokimeats" },
  { handle: "@man.bro__", name: "Ｍａｎｂｒｏ 🔵", followers: 6070, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Artist · Follows @dokimeats" },
  ...
  { handle: "@dishathahryamal", name: "Disha Tharyamal", followers: 6363, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@nanaiah_hottengada", name: "Nanaiah", followers: 3781, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · Follows @dokimeats" },
  { handle: "@fit__spirit__", name: "Neha 🦋", followers: 3326, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@sope999", name: "Sohaib F Rizvi (SFR)", followers: 3648, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@artsy_eminence", name: "Akansha", followers: 5365, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@thejdawgofficial", name: "Saint", followers: 3704, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@ogo_bideshiniiii_", name: "Dhriti Roy Choudhury", followers: 3713, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  ...
  { handle: "@asharsunit", name: "Sunit Ashar", followers: 3666, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@anoushkaagoel", name: "Anoushka G.", followers: 6193, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@neil.panasare", name: "Neil Panasare", followers: 4160, niche: "—", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },];
