...
// ─── Constants ──────────────────────────────────────────────────────────────
const NICHES = ["Food & Snacks","Fitness & Health","Fashion & Beauty","Comedy","Nutritionist","Music","Leadership","Entertainment","Content Creator","Art & Design","Travel","Sports & Auto","Home & Decor","Wellness","Mom Content","Reading","Information","Education","D2C Brands","Gaming","Photography","Finance","Tech","Parenting"];
...
const NICHE_PROBLEM = {
  ...
  "Fashion & Beauty": { problem: "Lifestyle integration; DOKi as the trendy guilt-free snack for style & wellness-conscious consumers", product: "Chips" },
  "Entertainment":    { problem: "Viral reach; DOKi placed in entertaining content drives massive brand awareness", product: "Both" },
  "Content Creator":  { problem: "Authentic integration; DOKi woven into daily creator content normalizes the brand", product: "Both" },
  "Art & Design":     { problem: "Premium aesthetics; visually stunning DOKi content that elevates brand perception", product: "Chips" },
  "Sports & Auto":    { problem: "High-energy fuel; DOKi as the go-to protein snack for active enthusiasts", product: "Jerky" },
  "Home & Decor":     { problem: "At-home snacking; DOKi positioned in cozy lifestyle & entertaining moments", product: "Chips" },
...
const SEED_PROSPECTS = [
  ...
  { handle: "@nutellaonella", name: "Onella Rodriguez", followers: 321000, niche: "Fashion & Beauty", costPerDeliv: 0, numDelivs: 0 },
  ...
  // ── From DOKi Follower Analysis (Excel) — 3K+ followers, F2F ratio ≥ 2 ──
{ handle: "@malluflix_official", name: "Athul Thampan", followers: 219947, niche: "Entertainment", costPerDeliv: 0, numDelivs: 0, note: "Reel creator · mallumoviereviews@gmail.com · Follows @dokimeats" },
  { handle: "@nandu_ofl", name: "Nandu", followers: 111151, niche: "Entertainment", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · businesswithnandu@gmail.com · Follows @dokimeats" },
  { handle: "@shaheenaggarwal", name: "SHAHEEN AGGARWAL", followers: 73512, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Education · speechmattersindia@gmail.com · Follows @dokimeats" },
  { handle: "@naina.pachnanda", name: "Naina Pachnanda Vaswani", followers: 124868, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@vijaysubramaniam84", name: "Vijay Subramaniam", followers: 72219, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@itsbhupesh", name: "Bhupesh Bansal", followers: 66015, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "bhupesh210@gmail.com · Follows @dokimeats" },
  { handle: "@saiynakhanna", name: "Saiyna Khanna", followers: 73261, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · saiyna@iplix.in · Follows @dokimeats" },
  { handle: "@sova_health", name: "Sova Health | Gut Health Company", followers: 41068, niche: "Nutritionist", costPerDeliv: 0, numDelivs: 0, note: "health · Health/beauty · support@sova.health · Follows @dokimeats" },
  { handle: "@rohankurupfitness", name: "Rohan Kurup | Online Transformation Coach", followers: 10729, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "muscle · Coach · rohan@rohankurupfitness.com · Follows @dokimeats" },
  { handle: "@simi_chadha_", name: "Simi Chadha", followers: 68614, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · Follows @dokimeats" },
  { handle: "@_akhilkrishnaa", name: "Akhil Krishna", followers: 50237, niche: "Mom Content", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@ojaswinikambli", name: "Ojaswini Kambli", followers: 66314, niche: "Art & Design", costPerDeliv: 0, numDelivs: 0, note: "Artist · ojaswinikambli@yahoo.in · Follows @dokimeats" },
  { handle: "@raihanrvadra", name: "Raihan", followers: 44074, niche: "Art & Design", costPerDeliv: 0, numDelivs: 0, note: "Artist · raihanrrv@gmail.com · Follows @dokimeats" },
  { handle: "@farmizenofficial", name: "Farmizen - Farm, Together", followers: 131962, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Community · support@farmizen.com · Follows @dokimeats" },
  { handle: "@akshaynagori", name: "Akshay Nagori", followers: 20754, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "food · Actor · akshayynagori@gmail.com · Follows @dokimeats" },
  { handle: "@evelynjubysan11", name: "Evelyn Elizabeth San", followers: 120109, niche: "Entertainment", costPerDeliv: 0, numDelivs: 0, note: "Reel creator · evelyn@bluboxtalents.com · Follows @dokimeats" },
  ...
  { handle: "@riidawg", name: "Ria Panjabi", followers: 13099, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "eat · Artist · thehotbox.in@gmail.com · Follows @dokimeats" },
  ...
  { handle: "@ritnikanayan", name: "Ritnika Nayan", followers: 21231, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Author · Follows @dokimeats" },
  { handle: "@itsbenabel", name: "Ben Abel | Faith, Wealth & Mindset", followers: 11796, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@shivanijai_", name: "shivani jai ★", followers: 41413, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Fashion Model · Follows @dokimeats" },
  { handle: "@urjita_wani", name: "Urjita Wani", followers: 76469, niche: "Comedy", costPerDeliv: 0, numDelivs: 0, note: "Comedian · Follows @dokimeats" },
  { handle: "@ashna_barretto", name: "Ashna Anastasia Barretto", followers: 13630, niche: "Mom Content", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@ronica_singh", name: "Ronnica 💙", followers: 46732, niche: "Entertainment", costPerDeliv: 0, numDelivs: 0, note: "Actor · Follows @dokimeats" },
  { handle: "@ashaiscool", name: "Asha Thacker", followers: 33184, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@shambhavi_shiva", name: "Shambhavi Shiva 🇮🇳", followers: 46307, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@diza.surryavanshi", name: "diz<33", followers: 12494, niche: "Art & Design", costPerDeliv: 0, numDelivs: 0, note: "eat · Artist · Follows @dokimeats" },
  { handle: "@chairs_and_company", name: "Chairs & Company - Bespoke Furniture Studio", followers: 14381, niche: "Home & Decor", costPerDeliv: 0, numDelivs: 0, note: "Furniture · chairsandcompany1069@gmail.com · Follows @dokimeats" },
  { handle: "@mua_suparna", name: "MUA SUPARNA || Bridal Makeup Artist🌸", followers: 33340, niche: "Fashion & Beauty", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · Follows @dokimeats" },
  { handle: "@poona.cartel", name: "The Poona Cartel", followers: 11952, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Local business · poonacartel@gmail.com · Follows @dokimeats" },
  { handle: "@rachelsfrancis", name: "Rachel Francis", followers: 10309, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "rachelfrancisbookings@gmail.com · Follows @dokimeats" },
  { handle: "@smallbatch_co", name: "Small Batch Co.", followers: 4642, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "eat · sanghirhea@gmail.com · Follows @dokimeats" },
  { handle: "@culinarycartel", name: "Akshita Paul 🍽", followers: 23740, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · theculinarycartel@gmail.com · Follows @dokimeats" },
  { handle: "@jomon.thomas8384", name: "Jomon Thomas", followers: 15863, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@busy_avacadobee", name: "Franisha Francis Lifestyle", followers: 15120, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "review · Blogger · franifrancis433@gmail.com · Follows @dokimeats" },
  { handle: "@beyondgeography", name: "ʙᴇʏᴏɴᴅ ɢᴇᴏɢʀᴀᴘʜʏ ✈︎", followers: 21912, niche: "Travel", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@dubaeee", name: "Aryan", followers: 11566, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@shia.og", name: "Shia OG", followers: 30496, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@pratikudhwani", name: "Pratik Udhwani", followers: 19300, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · Follows @dokimeats" },
  { handle: "@voyagebyagilan", name: "Agilan dante", followers: 10247, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · akilan1995@gmail.com · Follows @dokimeats" },
  { handle: "@missnavyarao", name: "Navya Pulagala", followers: 17830, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@blithe.live", name: "Ekansh Aggarwal / BLITHE.", followers: 15538, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Artist · Follows @dokimeats" },
  { handle: "@_thisgirlisnoone_", name: "Shikha", followers: 22057, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@velocitykannur", name: "Velocity Pub & Kitchen Kannur", followers: 9985, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "kitchen · Follows @dokimeats" },
  { handle: "@aayushvyas09", name: "Aayush Vyas", followers: 10830, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@souvikdutta_11", name: "Souvik Dutta", followers: 15152, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@the.realradhika", name: "Radhika 🍒", followers: 35560, niche: "Fashion & Beauty", costPerDeliv: 0, numDelivs: 0, note: "Fashion Model · Follows @dokimeats" },
  { handle: "@shekkkkp", name: "Abhishek Patil", followers: 15487, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@vapour_sarjapur", name: "Vapour Sarjapur", followers: 6240, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Brewery · gm@vapour.in · Follows @dokimeats" },
  { handle: "@cheeseareus", name: "CHEESESAREUS", followers: 4537, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Entrepreneur · cheesesareus42@gmail.com · Follows @dokimeats" },
  { handle: "@parapopofficial", name: "PARAPOP by PARALOVE", followers: 8124, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Community · parapop@paralove.in · Follows @dokimeats" },
  { handle: "@rawshan_official", name: "Roshan Banerjee", followers: 12644, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Dancer · banerje.roshan@gmail.com · Follows @dokimeats" },
  { handle: "@dikshika.boxfit", name: "Dikshika Rawat", followers: 8946, niche: "Mom Content", costPerDeliv: 0, numDelivs: 0, note: "fit · Follows @dokimeats" },
  { handle: "@thebuffmoto", name: "BuffMoto | Motovlogs", followers: 6154, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "muscle · Public figure · Follows @dokimeats" },
  { handle: "@sharanya.x", name: "Shar", followers: 9073, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "eat · Follows @dokimeats" },
  { handle: "@speed_mutant", name: "Shekhar Singh", followers: 11633, niche: "Sports & Auto", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@yashraj99", name: "Yashraj Pandit", followers: 12013, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@speedworksofficial", name: "SPEEDWORKS® - Tuning, Dyno, Racing", followers: 4848, niche: "Sports & Auto", costPerDeliv: 0, numDelivs: 0, note: "Motorsports Store · hq@speedworks.cc · Follows @dokimeats" },
  { handle: "@saaviwadhwaa", name: "Saavi ⭐️", followers: 5208, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "gym · Musician · Follows @dokimeats" },
  { handle: "@aishaupmanyu", name: "Aisha Upmanyu", followers: 8184, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "manyumanyu@gmail.com · Follows @dokimeats" },
  { handle: "@unstoppable_malem", name: "MalemNganba Takhelmayum", followers: 4931, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "gym, fit · Follows @dokimeats" },
  { handle: "@chitra_nalwade93", name: "Chitra Nalwade", followers: 35885, niche: "Mom Content", costPerDeliv: 0, numDelivs: 0, note: "Blogger · Follows @dokimeats" },
  { handle: "@v1n33", name: "Vineeth Sivakumar", followers: 11782, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@magdumshubham", name: "Shubham Magdum", followers: 13912, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@nehaketo", name: "Neha & Keto 🥑", followers: 8673, niche: "Nutritionist", costPerDeliv: 0, numDelivs: 0, note: "health · Personal Coach · nehaandketo@gmail.com · Follows @dokimeats" },
  { handle: "@call_me_tyi", name: "Tufan Deka", followers: 4069, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "food · Artist · dekaribu@gmail.com · Follows @dokimeats" },
  { handle: "@k.m.g.music", name: "K.M.G (Karan Gupta)", followers: 3339, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Musician · karanmahipalgupta@gmail.com · Follows @dokimeats" },
  { handle: "@rosetomyphoto", name: "Rose Tomy", followers: 6465, niche: "Art & Design", costPerDeliv: 0, numDelivs: 0, note: "Photographer · rosetomy.france@gmail.com · Follows @dokimeats" },
  { handle: "@_sandip_0666", name: "Sandip Anand Choudhury", followers: 9201, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@mridulaganesan", name: "Mridula Ganesan", followers: 5350, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Entrepreneur · ganesanmridula@gmail.com · Follows @dokimeats" },
  { handle: "@beyondlayouts", name: "Prathap Suthan", followers: 3064, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Writer · prathapsuthan@gmail.com · Follows @dokimeats" },
  { handle: "@ummesalma3_", name: "Ummesalma shakir", followers: 3529, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@apurvagovind", name: "Apurva A Govind", followers: 7352, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@msmunniforlittles", name: "Munira", followers: 5158, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@jaikumarchristhurajan", name: "Jaikumar Christurajan", followers: 6298, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@cat.on.cocaine", name: "Promita", followers: 6260, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@thewonderersoul", name: "Arunima", followers: 3716, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "food · Follows @dokimeats" },
  { handle: "@areeb_saifi_", name: "AREEB SAIFI", followers: 3210, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "muscle · Digital creator · Follows @dokimeats" },
  { handle: "@travellinghaathi", name: "Kshitij Choudhary", followers: 4043, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Artist · contact@kshitijchoudhary.in · Follows @dokimeats" },
  { handle: "@rayyanmonkey", name: "Rayyan (Rayyana)", followers: 7502, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "search@fatsmeagol.org · Follows @dokimeats" },
  { handle: "@alangkirat", name: "Kirat Alang", followers: 3227, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Film Director · kiratalang2@gmail.com · Follows @dokimeats" },
  { handle: "@man.bro__", name: "Ｍａｎｂｒｏ 🔵", followers: 6070, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Artist · Follows @dokimeats" },
  { handle: "@doctor.rayee", name: "Tabish Rayee", followers: 3318, niche: "Nutritionist", costPerDeliv: 0, numDelivs: 0, note: "health · Doctor · Follows @dokimeats" },
  { handle: "@devika.26", name: "devika sharma", followers: 6184, niche: "Mom Content", costPerDeliv: 0, numDelivs: 0, note: "Actor · devikasharma2611@gmail.com · Follows @dokimeats" },
  { handle: "@dishathahryamal", name: "Disha Tharyamal", followers: 6363, niche: "Sports & Auto", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@nanaiah_hottengada", name: "Nanaiah", followers: 3781, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · Follows @dokimeats" },
  { handle: "@fit__spirit__", name: "Neha 🦋", followers: 3326, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@sope999", name: "Sohaib F Rizvi (SFR)", followers: 3648, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@artsy_eminence", name: "Akansha", followers: 5365, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@thejdawgofficial", name: "Saint", followers: 3704, niche: "Leadership", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@ogo_bideshiniiii_", name: "Dhriti Roy Choudhury", followers: 3713, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@paulsonskaria", name: "Paulson Skaria", followers: 5986, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Artist · Follows @dokimeats" },
  { handle: "@pankhurizd", name: "Pankhuri Zaheer Dasgupta", followers: 4882, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@asharsunit", name: "Sunit Ashar", followers: 3666, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@anoushkaagoel", name: "Anoushka G.", followers: 6193, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  { handle: "@neil.panasare", name: "Neil Panasare", followers: 4160, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Follows @dokimeats" },
  // ── Manually added creators ──
  { handle: "@iheartgauravi", name: "Gauravi", followers: 4536, niche: "Fashion & Beauty", costPerDeliv: 0, numDelivs: 0, note: "Model · Fashion & lifestyle · Represented by @inega.in · 147 posts · Follower:Following ratio 64.8 · Viral reels (29.5K, 24.7K views)" },
  // ── From DOKi Influencer Database (Excel) — >7K followers, F2F ≥ 2 ──
  { handle: "@mojorojo", name: "Rohan Joshi", followers: 698969, niche: "Comedy", costPerDeliv: 0, numDelivs: 0, note: "Comedian · From Influencer Database" },
  { handle: "@ral.livezy", name: "Ralston D'Souza", followers: 623238, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@ayeshaadlakha", name: "Ayesha Kapoor Adlakha", followers: 427516, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "ayesha.adlakha@gmail.com · From Influencer Database" },
  { handle: "@thatquirkymiss", name: "Aditi Shrestha", followers: 304912, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · From Influencer Database" },
  { handle: "@prapti.elizabeth", name: "prapti", followers: 252576, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Grocery Store · From Influencer Database" },
  { handle: "@flexcia_dsouza", name: "Flexcia D'souza | Goa | Travel", followers: 156975, niche: "Travel", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · From Influencer Database" },
  { handle: "@theanurags", name: "Anurag Salgaonkar", followers: 146531, niche: "Art & Design", costPerDeliv: 0, numDelivs: 0, note: "VFX Artist · Video Creator · From Influencer Database" },
  { handle: "@twiinklesaaj", name: "Twiinkle Saaj", followers: 144954, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@shwetavijaynair", name: "Shweta", followers: 135334, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · From Influencer Database" },
  { handle: "@shalva_kinjawdekar", name: "Shalva Kinjawadekar", followers: 129176, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Artist · From Influencer Database" },
  { handle: "@monabedre", name: "Mona Bedre", followers: 109550, niche: "Entertainment", costPerDeliv: 0, numDelivs: 0, note: "Actor · From Influencer Database" },
  { handle: "@iamumerbelal", name: "Umer Belal", followers: 106800, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@gayathryofficial", name: "Gayathri Babu (Get Roast)", followers: 104414, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Public figure · From Influencer Database" },
  { handle: "@trainwithguneet", name: "Guneet | Online Coach", followers: 98062, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "Coach · From Influencer Database" },
  { handle: "@mindfullofdaisies", name: "Chandni Kurup", followers: 94365, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@essentiallydesi", name: "Kelsey Brown", followers: 93839, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · From Influencer Database" },
  { handle: "@swatichopra17", name: "Swati Chopra", followers: 88597, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@sketchbuildride", name: "Sketch Build Ride", followers: 76950, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@harpreetpasricha", name: "Harpreet Pasricha", followers: 68868, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@arjungarewal", name: "Arjun Garewal", followers: 67399, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@johninindia7", name: "John In India 7", followers: 62581, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · From Influencer Database" },
  { handle: "@musicbymelli", name: "Melli", followers: 57649, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Musician/band · From Influencer Database" },
  { handle: "@lost.and.hungry", name: "Vinayak G/Food Photographer", followers: 56321, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Photographer · vinayak@lostandhungry.in · From Influencer Database" },
  { handle: "@chefonkar", name: "Gagan Onkar", followers: 53760, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Chef · From Influencer Database" },
  { handle: "@pop.tale", name: "Pop.tale", followers: 50965, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · From Influencer Database" },
  { handle: "@nityamehra19", name: "Nitya Mehra", followers: 50361, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Film director · From Influencer Database" },
  { handle: "@sanilsachar", name: "Sanil Sachar", followers: 50052, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Entrepreneur · From Influencer Database" },
  { handle: "@discover_resorts", name: "DISCOVER RESORTS", followers: 48878, niche: "Travel", costPerDeliv: 0, numDelivs: 0, note: "Resort · From Influencer Database" },
  { handle: "@surbhimehtani", name: "Surbhi Mehtani", followers: 48710, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@coachchaitanya", name: "Chaitanya Bhutani", followers: 46701, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "Coach · frommind2muscle@gmail.com · From Influencer Database" },
  { handle: "@the_lifetimes", name: "The LifeTimes", followers: 46519, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "News & media website · From Influencer Database" },
  { handle: "@karnofthehills", name: "Karan Kashyap", followers: 45085, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@niharika.raina", name: "Niharika Raina", followers: 42839, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · From Influencer Database" },
  { handle: "@historywali", name: "Shubhra Chatterji", followers: 42072, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Writer · From Influencer Database" },
  { handle: "@avinash_makhija", name: "Avinash Makhija", followers: 40994, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · From Influencer Database" },
  { handle: "@soulfullysimi", name: "Simran Bedi", followers: 40770, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@foodbeforepillsbylalit", name: "Lalit Gupta", followers: 38854, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Health food store · From Influencer Database" },
  { handle: "@handpickedbypc", name: "Priyanka Chopra", followers: 36621, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Blogger · From Influencer Database" },
  { handle: "@pinkpockettv", name: "Pink Pocket", followers: 36107, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Media/news company · From Influencer Database" },
  { handle: "@theroguespectreofficial", name: "Syed Ali Mehdi Zaidi", followers: 35875, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@radha_thefunnyfoodie", name: "Radha", followers: 35585, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Artist · From Influencer Database" },
  { handle: "@jetsetcelestee", name: "Celestn Don", followers: 31715, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Artist · From Influencer Database" },
  { handle: "@tastytreatsandaman", name: "Tasty Treats", followers: 31596, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Food & beverage company · From Influencer Database" },
  { handle: "@devika.chawla", name: "Devika Chawla", followers: 30875, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@whyanmolwhy", name: "Anmol", followers: 29965, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@djsmitz", name: "Dj Smitz", followers: 29700, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "DJ · From Influencer Database" },
  { handle: "@rickyraymond.gif", name: "Ricky Raymond", followers: 29360, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · From Influencer Database" },
  { handle: "@theburlappeople", name: "The Burlap People", followers: 29122, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Bag/luggage store · From Influencer Database" },
  { handle: "@komorebi.music", name: "Tarana Marwah | Komorebi", followers: 28725, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Musician/band · From Influencer Database" },
  { handle: "@zokhuma", name: "Zokhuma", followers: 28192, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Musician/band · From Influencer Database" },
  { handle: "@sahildua87", name: "Sahil Dua", followers: 27785, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@ekstasyindia", name: "EKstasy", followers: 26942, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Restaurant · From Influencer Database" },
  { handle: "@menmodify", name: "Ezaz Shaikh", followers: 26746, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@iamjaidhaliwal", name: "Jai Dhaliwal", followers: 25855, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@malabartearoom", name: "Aysha Tanya", followers: 23506, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@rohinsarin", name: "Rohin Sarin", followers: 22498, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · From Influencer Database" },
  { handle: "@annam_food_vlog", name: "Mohammed Ansari | Food Vlogger", followers: 22358, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Reel creator · From Influencer Database" },
  { handle: "@nuancedart", name: "Rikrivu Banerjee", followers: 22307, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Artist · From Influencer Database" },
  { handle: "@tarajames1702", name: "Tara James", followers: 21219, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Entrepreneur · From Influencer Database" },
  { handle: "@sergiobarbozajr_", name: "Barboza", followers: 21147, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Athlete · From Influencer Database" },
  { handle: "@coachmirinall", name: "Mirinall Muthu | Fitness Coach", followers: 20264, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@thesiddvengali", name: "Siddhanth Vengali", followers: 19316, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Entrepreneur · From Influencer Database" },
  { handle: "@barbaravian", name: "Barbara Avian", followers: 19181, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Reel creator · From Influencer Database" },
  { handle: "@vidushiis", name: "Vidushii Shrivastava", followers: 18666, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · From Influencer Database" },
  { handle: "@thegoodstuff.cafe", name: "The Good Stuff", followers: 17965, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Coffee shop · From Influencer Database" },
  { handle: "@rishman123", name: "Rishi Baveja", followers: 17631, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Entrepreneur · From Influencer Database" },
  { handle: "@tejpandit_ifbbpro", name: "IFBB Pro Tejaswini Pandit", followers: 17368, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "Coach · tejupandit12@gmail.com · From Influencer Database" },
  { handle: "@foodtrendsthrumylens", name: "Nitin Jagga", followers: 17250, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@snehachawla2004", name: "Sneha", followers: 16995, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · From Influencer Database" },
  { handle: "@rahulgogoi.cosmeticsurgery", name: "Rahul Gogoi", followers: 16566, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Doctor · From Influencer Database" },
  { handle: "@richadhillon_mua", name: "Richa Dhillon", followers: 15413, niche: "Fashion & Beauty", costPerDeliv: 0, numDelivs: 0, note: "Beauty & personal care · From Influencer Database" },
  { handle: "@ro.mehra", name: "Rohini Mehra", followers: 15394, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@neerajasmehta", name: "Neeraja S Mehta", followers: 15313, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Vitamins/supplements · From Influencer Database" },
  { handle: "@a.neetu", name: "Neetu Arora", followers: 15162, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@earthful.sisters", name: "Earthful Sisters", followers: 14928, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "Health/beauty · From Influencer Database" },
  { handle: "@carologue30", name: "Carolyn", followers: 14695, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@imrajbirhotta", name: "Raj Bir Hotta", followers: 14605, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@mrinalc", name: "Mrinal C", followers: 14503, niche: "Music", costPerDeliv: 0, numDelivs: 0, note: "Artist · From Influencer Database" },
  { handle: "@kiran_lakhani", name: "Kiran Lakhani", followers: 14263, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@supriyapaul", name: "Supriya Paul", followers: 13992, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Entrepreneur · From Influencer Database" },
  { handle: "@theblogofdoctorsuz", name: "Dr. Susan Roy MDS", followers: 13988, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Blogger · suz963@gmail.com · From Influencer Database" },
  { handle: "@snehataurani", name: "Sneha Taurani", followers: 13824, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@chetnamalik", name: "Chetna Malik", followers: 13770, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@suvam.moitra", name: "Suvam Moitra", followers: 13610, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@alistairdmonte", name: "Alistair D'monte", followers: 13381, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@oneandocompany", name: "One & O", followers: 13322, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Product/service · From Influencer Database" },
  { handle: "@janakikrishnan21", name: "Janaki Krishnan", followers: 13297, niche: "Entertainment", costPerDeliv: 0, numDelivs: 0, note: "Actor · babhishekshastri@gmail.com · From Influencer Database" },
  { handle: "@singhmeghal", name: "Meghal Singh", followers: 13271, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@devavrat.mtk", name: "Devavrat Matkari", followers: 12985, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@manoshinath", name: "Manoshi Nath", followers: 12834, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@itskrystallllll", name: "Krystal D", followers: 12777, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@goforbg", name: "Bharadwaj Giridhar", followers: 12666, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@iamvarunpatel", name: "Varun Patel", followers: 12481, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@danieldsouzaphoto", name: "Daniel D'souza", followers: 12345, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@roch_cakestudio", name: "Roch Cake Studio", followers: 12189, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Bakery · From Influencer Database" },
  { handle: "@isshaan_mudgal", name: "Isshaan Mudgal", followers: 12176, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@the_gold_queenie", name: "Gold Queenie", followers: 12097, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@croydonclicks", name: "Croydon Clicks", followers: 11914, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@meru_kapoor", name: "Meru Kapoor", followers: 11877, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@explorer.heena", name: "Heena", followers: 11775, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@deekshakaulgaitonde", name: "Deeksha Gaitonde", followers: 11756, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "Personal Coach · From Influencer Database" },
  { handle: "@tejkarran", name: "Tej Karran", followers: 11714, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@sonalikabhadouria", name: "Sonalika", followers: 11626, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "Digital creator · From Influencer Database" },
  { handle: "@therohanmahajan", name: "Rohan Mahajan", followers: 11603, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@saieshashetty_", name: "Saiesha Shetty", followers: 11329, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@nikhildarocha", name: "Nikhil Da Rocha", followers: 11287, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@bhaavusjournal", name: "Bhaavya Aghi", followers: 11172, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@fresh_n_frozen_co", name: "Fresh N Frozen Co", followers: 10997, niche: "Food & Snacks", costPerDeliv: 0, numDelivs: 0, note: "Food delivery service · From Influencer Database" },
  { handle: "@nimzi9", name: "Nimmy George", followers: 10752, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · From Influencer Database" },
  { handle: "@blush_tree", name: "Blush Tree by Brishti", followers: 10703, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@somyabakshi", name: "Somya Bakshi", followers: 10568, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@kajoldashkar", name: "Kajol Dashkar", followers: 10448, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@satsdas", name: "Satnam Das", followers: 10277, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@neeraj_bhandary", name: "Neeraj Bhandary", followers: 10102, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@aggressionvkt", name: "Aggression", followers: 10065, niche: "Fitness & Health", costPerDeliv: 0, numDelivs: 0, note: "Gym/physical fitness center · From Influencer Database" },
  { handle: "@mayursinghrathore", name: "Mayur Singh Rathore", followers: 9834, niche: "Content Creator", costPerDeliv: 0, numDelivs: 0, note: "From Influencer Database" },
  { handle: "@sne_hahahaa", name: "Sneha Roy", followers: 9184, niche: "Reading", costPerDeliv: 0, numDelivs: 0, note: "Personal blog · sneha1207@ymail.com · From Influencer Database" },
];
